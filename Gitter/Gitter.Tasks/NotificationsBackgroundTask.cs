...
namespace Gitter.WindowsPhone.Tasks
{
    public abstract class NotificationsBackgroundTask : IBackgroundTask
    {
        ...
        protected ILocalNotificationService _localNotificationService;
        protected IGitterApiService _gitterApiService;
        protected IPasswordStorageService _passwordStorageService;
        protected IApplicationStorageService _applicationStorageService;
